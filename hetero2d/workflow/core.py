...
def get_heterostructures_stabilityWF(struct_2d, struct_sub, struct_3d2d, heterotransformation_params,
                                     slab_params, user_additions, tags={}, bin_2d=VASP_CMD, bin_3d=VASP_CMD,
                                     dipole=None, uis=None,
                                     uis_2d=None, vis_2d=None, uis_3d2d=None, vis_3d2d=None, uis_bulk=None,
                                     vis_bulk=None,
...
def wf_electronic(structure, tags={}, user_additions={}, prev_calc_dir=None,
    ...
    # Charge Density Difference
        ...
        if split_idx == None:  # raise error if cdd dict not present
            raise ValueError("You have specified a charge density difference" \
